...
export default function App() {
  ...
  return (
    <div className="bg-[#050505] text-white font-mono overflow-x-hidden">
      ...
      <div className="relative z-10 w-full pointer-events-none">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center p-6 pt-20">
          ...
          >
            {/* PROFILE PICTURE (Needs /cutout.png in public folder) */}
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
              <div className="bg-gray-900/60 border-l-4 border-purple-500 p-8 backdrop-blur-md rounded-r-xl hover:bg-gray-800/80 transition-all border-y border-r border-gray-800">
                <h3 className="text-2xl text-purple-400 mb-4 font-bold">Cloud & Infrastructure</h3>
                <p className="text-gray-300 leading-relaxed">AWS (VPC, EC2, S3, ELB, RDS, DynamoDB, Route53)</p>
              </div>
              <div className="bg-gray-900/60 border-l-4 border-purple-500 p-8 backdrop-blur-md rounded-r-xl hover:bg-gray-800/80 transition-all border-y border-r border-gray-800">
                <h3 className="text-2xl text-purple-400 mb-4 font-bold">Security & Networking</h3>
                <p className="text-gray-300 leading-relaxed">Netskope SASE, DLP, SSL/TLS, IPsec, Azure AD</p>
                <p className="text-gray-400 mt-2 text-sm border-t border-gray-700 pt-2">TCP/IP, DNS, Load Balancing, Citrix Gateway</p>
              </div>
              <div className="bg-gray-900/60 border-l-4 border-purple-500 p-8 backdrop-blur-md rounded-r-xl hover:bg-gray-800/80 transition-all md:col-span-2 border-y border-r border-gray-800">
                <h3 className="text-2xl text-purple-400 mb-4 font-bold">Diagnostics & Code</h3>
                <p className="text-gray-300">Wireshark, TCP Dumps, Packet & Log Analysis | Java, REST APIs, Python, MySQL</p>
              </div>
            </div>
          </motion.div>
        </section>
            ...
            <div className="space-y-12 bg-black/40 p-8 rounded-2xl backdrop-blur-sm border border-gray-800">
              ...
              <div className="relative pl-8 border-l-2 border-green-500">
                ...
                <h3 className="text-3xl font-bold text-white flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                  Netskope 
                  <span className="text-sm font-normal bg-green-500/20 text-green-400 px-3 py-1 rounded-full w-fit">Nov 2024 - Present</span>
                </h3>
                <p className="text-purple-400 mt-2 mb-3 font-bold text-lg">Senior Cloud Support Engineer</p>
                <p className="text-gray-300 leading-relaxed max-w-3xl">Handling and solving high severity cases for Clients on Netskope, NPA, Explicit Proxy, DLP, Effective integration with other AWS services.</p>
              </div>
              ...
              <div className="relative pl-8 border-l-2 border-purple-500/50">
                ...
                <h3 className="text-3xl font-bold text-gray-200 flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                  Citrix 
                  <span className="text-sm font-normal bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full w-fit">Mar 2024 - Nov 2024</span>
                </h3>
                <p className="text-purple-400/80 mt-2 mb-3 font-bold text-lg">Citrix Cloud Support Engineer</p>
                <p className="text-gray-400 leading-relaxed max-w-3xl">Delivered L2 technical support for Citrix ADC (NetScaler), Gateway, and Virtual Apps & Desktops. Troubleshot load balancing, SSL offloading, VPN.</p>
              </div>
              ...
              <div className="relative pl-8 border-l-2 border-gray-700">
                ...
                <h3 className="text-3xl font-bold text-gray-400 flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                  Josh Software 
                  <span className="text-sm font-normal bg-gray-800 text-gray-400 px-3 py-1 rounded-full w-fit">June 2022 - Oct 2023</span>
                </h3>
                <p className="text-purple-400/50 mt-2 mb-3 font-bold text-lg">Cloud Software Engineer</p>
                <p className="text-gray-500 leading-relaxed max-w-3xl">Designed and developed enterprise-grade microservices using Java, Spring Boot, and AWS. Migrated applications from Azure to AWS.</p>
              </div>
